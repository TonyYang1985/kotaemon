...
KH_RERANKINGS = {
    ...
    "voyageai": {
        "spec": {
            ...
            "api_key": config("VOYAGE_API_KEY", default="your-key"),
        },
        "default": False,
    },
    "tei": {
        "spec": {
            ...
            "endpoint_url": config("TEI_RERANKING_URL", default="http://localhost:8080/rerank"),
...
# Add Ollama reranking if local model is configured
if config("LOCAL_MODEL", default=""):
